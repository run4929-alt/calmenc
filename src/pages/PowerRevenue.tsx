import svgPaths from "@/imports/웹사이트제작요청-5/svg-9u5vaadexi";
import heroImg from "@/imports/웹사이트제작요청-5/f05155a44b99577f8017b6df5384b078b159370b.png";
...
const reasonCards = [
  {
    n: "01 직접 시공",
    title: "설계 · 시공 · 관리 한 회사가 맡습니다",
    desc: "전기공사업 면허로 직접 시공합니다",
  },
  {
    n: "02 인허가",
    title: "AI 인허가 자동화",
  ...
  },
  {
    n: "03 자금 조달",
    title: "자기자본 10%로 시작",
    desc: "사업비의 최대 90%까지 대출 가능, 신청 서류 준비까지 지원해 드립니다.\n원리금은 발전 수익으로 · 추가 부담 없음",
  },
  {
    n: "04 관리",
    title: "인버터 원격 관제",
...
const incomeRows = [
  { yr: "1년차",  rev: "3,147만원", mgmt: "222만원", net: "2,925만원", cum: "2,925만원" },
  { yr: "5년차",  rev: "3,085만원", mgmt: "222만원", net: "2,863만원", cum: "1.45억" },
  { yr: "6년차",  rev: "3,069만원", mgmt: "422만원", net: "2,647만원", cum: "1.71억" },
  { yr: "10년차", rev: "3,008만원", mgmt: "422만원", net: "2,586만원", cum: "2.76억" },
  { yr: "15년차", rev: "2,934만원", mgmt: "422만원", net: "2,512만원", cum: "4.03억" },
  { yr: "20년차", rev: "2,861만원", mgmt: "422만원", net: "2,439만원", cum: "5.26억" },
  { yr: "25년차", rev: "2,790만원", mgmt: "422만원", net: "2,368만원", cum: "6.46억" },
];

const financeRows = [
  { label: "총 사업비",             value: "1.3억원",  unit: "kW 당 130만원 기준" },
  { label: "자기자본 (10%)",        value: "약 1,300", unit: "대출 90% 기준" },
  { label: "월 발전 수익",          value: "262만원",  unit: "연 약 3,100만원" },
  { label: "전기안전관리자 선임",   value: "월 18.5",  unit: "100kW 이상 시 월 35만원" },
  { label: "O&M 유지관리 (5년 후)", value: "연 200만", unit: "솔라캄이 관리 대행" },
];

export default function PowerRevenue() {
  const [openFaq, setOpenFaq] = useState<number | null>(null);

  const faqs = [
    {
      q: "대출은 얼마나 받을 수 있나요?",
      a: "사업비의 최대 90%까지 가능하며, 시중은행 시설자금과 한국에너지공단 정책자금 융자 두 가지 경로가 있습니다. 솔라캄이 신청 서류 준비를 지원해 드립니다. 승인 여부와 한도는 사업주의 신용도, 담보 평가 등 금융기관 심사 결과에 따라 결정되며, 대출 계약은 금융기관과 직접 체결하십니다.",
    },
    {
      q: "발전 수익은 어떻게 발생하나요?",
      a: "생산된 전기를 한국전력에 판매(SMP)하고, 신재생에너지 인증서(REC)를 발전공기업에 판매하여 수익이 발생합니다. SMP + REC 합산으로 kWh당 수익이 결정됩니다.",
    },
    {
      q: "30년 후 태양광 설비는 어떻게 되나요?",
      a: "모듈 발전 효율은 연 0.5%씩 서서히 감소하며, 30년 시점에도 초기 대비 약 86% 수준의 발전량이 유지됩니다.",
    },
  ];
    ...
    <div className="w-full">
        ...
        <div className="flex flex-col-reverse md:flex-row items-start md:items-center md:justify-between gap-8 md:gap-0 min-h-[auto] md:h-[804px] max-w-[1152px] py-12 md:pb-[30px] md:pt-0 px-5 md:px-8 w-full">
          <div className="pr-hero-text flex flex-[1_0_0] flex-col gap-10 items-start max-w-[672px] min-w-px">
            <div className="flex flex-col gap-4 items-start font-['Pretendard:Bold',sans-serif] not-italic">
              <p className="leading-[1.5] text-[#7e8a96] text-[15px] md:text-[25px]">발전수익 받기</p>
          ...
          <div className="hidden md:block pr-hero-img bg-white overflow-hidden relative rounded-[30px] shrink-0 size-[480px] transition-transform duration-700 hover:scale-[1.015]">
            <div className="absolute h-[728px] left-0 top-[-206px] w-[485px]">
              <img
                alt="공장 지붕 위 태양광 발전소"
      ...
      <div className="bg-white w-full flex flex-col items-center overflow-hidden">
        <div className="flex flex-col gap-8 items-start max-w-[1152px] pb-12 md:pb-[120px] pt-12 md:pt-[160px] px-5 md:px-8 w-full">
          ...
          <Reveal>
            <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[1.6] not-italic text-[#637282] text-[12px] sm:text-[14px] break-keep">
              * 대출 승인 여부와 한도는 사업주의 신용도, 담보 평가 등 금융기관 심사 결과에 따라 결정됩니다. 대출 계약은 금융기관과 직접 체결하시며, 당사는 서류 준비를 지원합니다.
            </p>
          </Reveal>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-14 md:gap-[100px] items-center max-w-[1152px] px-5 md:px-8 py-12 md:py-[160px] w-full">
          ...
          <Reveal>
            <div className="flex flex-col items-center justify-center max-w-[768px]">
              <div className="font-['Pretendard:SemiBold',sans-serif] not-italic text-[20px] sm:text-[26px] md:text-[38px] text-center text-white">
                <p className="leading-[1.5] break-keep">태양광 발전소 분양 자기 발전소로</p>
                <p className="leading-[1.5] break-keep">30년간 수익 전액을 가져가세요!</p>
              </div>
            </div>
          </Reveal>
              ...
              <div className="flex flex-col gap-6 items-center">
                ...
                <div className="flex flex-col gap-3 items-center not-italic">
                  <div
                    ...
                    style={{ backgroundImage: "linear-gradient(123.31546930319112deg, rgb(255, 255, 255) 7.5546%, rgb(233, 246, 75) 96.19%)" }}
                  >
                    약 8.79억원
                  </div>
                  <div className="flex flex-col gap-1 items-center justify-center text-center">
                    ...
                    <p className="font-['Pretendard_Variable:Medium',sans-serif] leading-[1.6] text-[12px] sm:text-[14px] text-[rgba(255,255,255,0.6)] text-center break-keep max-w-[440px]">
                      전시간 3.7h/일 · SMP+REC 합산 233원/kWh · 발전율 저하 연 0.5% 적용
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-4 items-start w-full">
              ...
              <Reveal className="w-full" delay={160}>
                <div className="bg-[#f2f3f5] flex flex-col gap-6 items-start p-5 sm:p-[30px] rounded-[16px] w-full">
                  <p className="font-['Pretendard_Variable:SemiBold',sans-serif] leading-[1.36] text-[#1f2129] text-[14px] sm:text-[16px]">자금 조달 방식</p>
                  <div className="flex flex-col gap-3 items-start">
                    <div className="flex flex-col gap-2 items-start text-black">
                      <p className="font-['Pretendard_Variable:Bold',sans-serif] leading-[1.3] text-[24px] sm:text-[30px] md:text-[34px]">자기자본 10%</p>
                      <p className="font-['Pretendard_Variable:SemiBold',sans-serif] leading-[1.6] text-[14px] sm:text-[18px]">+ 은행 대출 최대 90%</p>
                    </div>
                    <p className="font-['Pretendard_Variable:SemiBold',sans-serif] leading-[1.5] text-[#1f2129] text-[13px] sm:text-[17px] break-keep">
                      100kW 기준 자기자본 1,300만원만 있으면 됩니다
                    </p>
                  </div>
                  ...
                  <ul className="flex flex-col gap-1 font-['Pretendard_Variable:SemiBold',sans-serif] list-disc text-[13px] sm:text-[16px] md:text-[18px] text-black w-full pl-[18px]">
                    <li><span className="leading-[1.7]">자기자본 100% 또는 대출 병행 선택</span></li>
                    <li><span className="leading-[1.7]">발전 수익 100% 소유주 귀속</span></li>
                    <li><span className="leading-[1.7]">설치 + 유지관리 방식 선택 가능</span></li>
                    <li><span className="leading-[1.7]">원리금은 발전 수익으로 상환 · 추가 부담 없음</span></li>
                  </ul>
                </div>
              </Reveal>
        ...
        <div className="flex flex-col gap-8 items-start max-w-[1152px] px-5 md:px-8 py-12 md:py-[160px] w-full">
          ...
          <Reveal>
            <div className="flex flex-col gap-2 items-start max-w-[768px] w-full">
              ...
              <p className="font-['Pretendard:Regular',sans-serif] leading-[1.5] not-italic text-[#1f2129] text-[12px] sm:text-[14px] md:text-[18px] break-keep">
                100kW 발전소 · 발전시간 3.7h/일 · SMP+REC 233원/kWh · 발전율 저하 연 0.5%
              </p>
            </div>
          </Reveal>
              ...
              <table className="min-w-[480px] w-full border-collapse">
                <thead>
                  <tr className="bg-[#1f2129] text-white">
                    ...
                    <th className="px-3 sm:px-5 py-4 text-left font-['Pretendard:Bold',sans-serif] text-[12px] sm:text-[15px] font-normal">연 발전 수익</th>
                    <th className="px-3 sm:px-5 py-4 text-left font-['Pretendard:Bold',sans-serif] text-[12px] sm:text-[15px] font-normal">관리비</th>
                    <th className="px-3 sm:px-5 py-4 text-left font-['Pretendard:Bold',sans-serif] text-[12px] sm:text-[15px] font-normal">연 순수익</th>
                    <th className="px-3 sm:px-5 py-4 text-left font-['Pretendard:Bold',sans-serif] text-[12px] sm:text-[15px] font-normal">누적 순수익</th>
                  </tr>
                </thead>
                <tbody>
                  {incomeRows.map((row, i) => (
                    <tr key={row.yr} className={i % 2 === 0 ? "bg-white" : "bg-[#fafbfa]"}>
                      ...
                      <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:Medium',sans-serif] text-[12px] sm:text-[15px] text-[#40453f]">{row.rev}</td>
                      <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:Medium',sans-serif] text-[12px] sm:text-[15px] text-[#40453f]">{row.mgmt}</td>
                      <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:Medium',sans-serif] text-[12px] sm:text-[15px] text-[#40453f]">{row.net}</td>
                      <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:Bold',sans-serif] text-[12px] sm:text-[15px] text-[#101211]">{row.cum}</td>
                    </tr>
                  ))}
                  <tr style={{ background: "linear-gradient(90deg, #f9f9f9 0%, #e9f64b 45.673%, #f9f9f9 100%)" }}>
                    <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:SemiBold',sans-serif] text-[12px] sm:text-[15px] text-[#1f2129]">30년차</td>
                    <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:SemiBold',sans-serif] text-[12px] sm:text-[15px] text-[#1f2129]">2,721만원</td>
                    <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:SemiBold',sans-serif] text-[12px] sm:text-[15px] text-[#1f2129]">422만원</td>
                    <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:SemiBold',sans-serif] text-[12px] sm:text-[15px] text-[#1f2129]">2,299만원</td>
                    <td className="px-3 sm:px-5 py-[13px] font-['Pretendard:SemiBold',sans-serif] text-[12px] sm:text-[15px] text-[#1f2129]">7.62억</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <Reveal delay={160} className="w-full">
            <div className="flex flex-col gap-3 items-start max-w-[1088px] w-full">
              <div className="bg-[#1f2129] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-5 sm:p-[30px] rounded-[16px] w-full">
                <div className="bg-[#3a3c46] flex items-start px-4 py-2 rounded-[7px]">
                  <p className="font-['Pretendard_Variable:Bold',sans-serif] leading-[1.6] not-italic text-[15px] sm:text-[20px] text-white">30년 총 순이익</p>
                </div>
                <div
                  ...
                  style={{ backgroundImage: "linear-gradient(122.6861373028221deg, rgb(255, 255, 255) 7.5546%, rgb(233, 246, 75) 96.19%)" }}
                >
                  약 7.62억원
                </div>
              </div>
            ...
            <div className="bg-white max-w-[1088px] rounded-[16px] w-full overflow-hidden">
              ...
              <div className="flex md:hidden flex-col items-center gap-6 px-5 py-8">
                ...
                <div className="bg-[#f2f3f5] flex flex-col gap-2 items-center px-5 py-4 rounded-[14px] w-full max-w-[220px]">
                  ...
                  <div className="bg-[#1f2129] flex items-center justify-center px-3 py-2 rounded-[8px] w-full">
                    <p className="font-['Pretendard:SemiBold',sans-serif] text-[12px] text-white">발전 수익 100% 귀속</p>
                  </div>
                </div>
                {/* 화살표 ↕ 지붕주 ↔ 솔라캄 */}
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="bg-[#f0f8bd] px-3 py-1 rounded-full">
                    <p className="font-['Pretendard:SemiBold',sans-serif] text-[#7f910d] text-[11px]">↓ 관리비 지급</p>
                  </div>
                </div>
                {/* 솔라캄 */}
              ...
              <div className="hidden md:flex items-center justify-center px-8 py-[40px]">
                <div className="flex gap-[28px] items-center justify-center">
                  {/* 한국전력 */}
                  <div className="bg-[#f2f3f5] flex flex-col gap-2 h-[150px] items-center justify-center not-italic p-5 rounded-full text-[#1f2129] text-center w-[150px] transition-transform duration-300 hover:scale-105">
                    <p className="font-['Pretendard:Bold',sans-serif] leading-[1.4] text-[16px]">한국전력</p>
                    <p className="font-['Pretendard:Regular',sans-serif] leading-[1.5] text-[12px]">전기 · REC 매입</p>
                  </div>
                  {/* arrows */}
                  <div className="flex flex-col gap-2 items-start">
                    <div className="bg-[#f0f8bd] flex items-center justify-center px-3 py-2 rounded-full">
                      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.5] not-italic text-[#7f910d] text-[12px]">← 전기 판매</p>
                    </div>
                    <div className="bg-[#f0f8bd] flex items-center justify-center px-3 py-2 rounded-full">
                      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.5] not-italic text-[#7f910d] text-[12px]">판매대금 지급 →</p>
                    </div>
                  </div>
                  {/* 지붕주 */}
                  <div className="bg-[#f2f3f5] flex flex-col gap-3 items-center px-4 py-4 rounded-[16px] transition-transform duration-300 hover:scale-105">
                    <div className="flex flex-col gap-2 items-center not-italic text-[#1f2129] text-center">
                      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.5] text-[13px]">사업 주체</p>
                      <div className="font-['Pretendard:Bold',sans-serif] text-[18px] leading-[1.4] text-center">
                        <p>축사·공장</p>
                        <p>지붕주</p>
                      </div>
                    </div>
                    <div className="bg-[#1f2129] flex items-center justify-center px-3 py-2 rounded-[8px] w-full">
                      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.5] not-italic text-[12px] text-white">발전 수익 100% 귀속</p>
                    </div>
                  </div>
                  {/* arrows */}
                  <div className="flex flex-col gap-2 items-start">
                    <div className="bg-[#f0f8bd] flex items-center justify-center px-3 py-2 rounded-full">
                      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.5] not-italic text-[#7f910d] text-[12px]">← 시공·운영관리 제공</p>
                    </div>
                    <div className="bg-[#f0f8bd] flex items-center justify-center px-3 py-2 rounded-full w-full">
                      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.5] not-italic text-[#7f910d] text-[12px]">관리비 지급 →</p>
                    </div>
                  </div>
                  {/* 솔라캄 */}
                  <div className="bg-[#101211] flex flex-col items-center justify-center pt-4 rounded-full size-[150px] transition-transform duration-300 hover:scale-105">
                    <div className="flex flex-col gap-2 items-center justify-center">
                      <SolacalmLogoYellow />
                      <p className="font-['Pretendard:Regular',sans-serif] leading-[1.5] not-italic text-[#f2f3f5] text-[12px] text-center">관리 주체</p>
                    </div>
                  </div>
                </div>
              </div>
